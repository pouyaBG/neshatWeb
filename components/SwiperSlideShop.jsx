...
const SwiperSlideShop = () => {
  ...
  return (
    ...
    >
      ...
      <SwiperSlide className="w-full max-h-[540px]">
        <div className="">
          <img src="/img/shop1.png" className="object-contain" />
        </div>
      </SwiperSlide>
      <SwiperSlide className="w-full max-h-[540px]">
        <div className="">
          <img src="/img/shop2.png" className="object-contain" />
        </div>
      </SwiperSlide>
    </Swiper>
  );
...
export default SwiperSlideShop;
