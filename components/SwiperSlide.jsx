...
const MySwiper = () => {
  ...
  return (
    ...
    >
      <div
        className="hidden lg:flex z-50 absolute top-20 left-28  flex-col justify-between items-center gap-10"
        data-aos="zoom-in"
      >
        <div
      ...
      <SwiperSlide className="w-full max-h-[640px]">
        <div className="relative">
          <p
            data-aos="fade-left"
            className="absolute lg:bottom-36 lg:right-32 bottom-8 right-2 text-white lg:text-[35px] not-italic font-bold leading-[normal] tracking-[-0.43px]"
          >
            چمن مصنوعی ورزشی
          </p>
          <p
            data-aos="fade-left"
            className="absolute lg:bottom-24 lg:right-32 bottom-2 right-2 text-[#DED60E] lg:text-[25px] not-italic font-thin leading-[normal] tracking-[-0.358px]"
          >
            سالن و دارای فضای باز
          </p>
          <img src="/svg/women.png" className="object-contain" />
        </div>
      </SwiperSlide>
      <SwiperSlide className="w-full max-h-[640px]">
        <div className="relative">
          ...
          <img src="/svg/chaman.png" className="object-contain" />
        </div>
      </SwiperSlide>
      <SwiperSlide className="w-full max-h-[640px]">
        <div className="relative">
          ...
          <img src="/svg/salon2.png" className="object-contain" />
        </div>
      </SwiperSlide>
    </Swiper>
  );
