  ...
  return (
    <section className="my-5 bg-white w-[79%] rounded-[15px] ">
      <div className="flex flex-col items-center  ">
        <div className="border-b border-[#000] border-opacity-30 w-[90%] text-center mb-3">
          <p className=" text-[#1D1D1D] text-[24px] not-italic font-bold leading-[normal] p-3">
            رزرو بلیط استخر و ماساژ
          </p>
        </div>
        <div className="w-full mt-5 flex flex-col items-center justify-center gap-5 mb-5">
