  ...
  const dataList = [
    {
      ...
      is: " مربی بدنسازی",
      isTo: "مربی شنا",
      item1: "  مسئول تدریس و طراحی برنامه‌های تمرینی",
      item2: " مسئول آموزش مهارت‌های ورزشی",
    },
    {
      title: "مدیران بازاریابی و ارتباطات",
      item1: "تبلیغات و ارتباطات برند مجموعه ورزشی",
    },
    {
      title: "تعمیرکاران و نگهدارندگان تجهیزات",
      item1: "مراقبت و نگهداری تجهیزات و وسایل ورزشی",
    },
    {
      title: "کارشناس برقکاری",
      item1: "نگهداری و تعمیر تجهیزات برقی",
      item2: "راه‌اندازی و نظارت بر سیستم‌های الکتریکی",
    },
    {
      title: "کارشناس سیستم تهوه مطبوع",
      item1: "نظارت بر سیستم‌های HVAC",
      item2: "برنامه‌ریزی و تعمیر و نگهداری",
    },
    {
      title: "پذیرش و اداری",
